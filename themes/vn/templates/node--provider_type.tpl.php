      ...
      elseif ($node->field_p_types['und'][0]['value'] == 'bu') {
        ...
        if ($view->result) {
          ...
          if ($view->result) {
            ...
            echo '<div class="block block-views"><h2 class="block-title">All VoIP Providers that Offer ' . $service_types[$node->field_p_types['und'][0]['value']] . ' VoIP Services</h2>' . $results . '</div>';
          }
          else {
